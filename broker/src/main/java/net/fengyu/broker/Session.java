...
//    private MarsConnection marsConnection;
...
//        this.marsConnection = mqttConnection;
//    }
//
//    boolean isBoundTo(MQTTConnection mqttConnection) {
//        return this.marsConnection == mqttConnection;
//    }
//
...
//        marsConnection.sendIfWritableElseDrop(pubRel);
//
...
//            case AT_MOST_ONCE:
//                if (connected()) {
//                    marsConnection.sendPublishQos0(topic, qos, payload, retained);
//                }
//                break;
//            case AT_LEAST_ONCE:
...
//        }
//
//        final MQTTConnection localMqttConnectionRef = marsConnection;
...
//            connected() &&
//            marsConnection.channel.isWritable();
//    }
//
...
//                inflightTimeouts.add(new InFlightPacket(notAckPacketId.packetId, FLIGHT_BEFORE_RESEND_MS));
//                marsConnection.sendPublish(publishMsg);
//            }
//        }
//    }
//
...
//            }
//            inflightSlots.decrementAndGet();
//            int sendPacketId = marsConnection.nextPacketId();
//
...
//        if (connected()) {
//            return Optional.of(marsConnection.remoteAddress());
//        }
